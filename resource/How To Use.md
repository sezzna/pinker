...
- 请在 conf/aws/credentials 文件中设置 S3 用户 aws_access_key_id 和 aws_secret_access_key如何使用
  ...
  4. 订阅异步事件
     ...
     ``` go
     micro.RegisterSubscriber("Event_RSC_GetRsc", service.Server(), EventHandler)micro.RegisterSubscriber("Event_RSC_GetPresignedURL", service.Server(), EventHandler)micro.RegisterSubscriber("Event_RSC_GetURL", service.Server(), EventHandler)
     ```
